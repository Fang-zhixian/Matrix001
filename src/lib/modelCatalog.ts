...
export const PROVIDER_CATALOG: ProviderCatalogEntry[] = [
  {
    ...
    models: [
      { id: 'gemini-2.5-flash', label: 'Gemini 2.5 Flash', description: 'Fast default model', capabilities: { image: true, pdf: true } },
      { id: 'gemini-2.5-pro', label: 'Gemini 2.5 Pro', description: 'Stronger reasoning model', capabilities: { image: true, pdf: true } },
      { id: 'gemini-2.0-flash', label: 'Gemini 2.0 Flash', description: 'Lower latency option', capabilities: { image: true, pdf: true } },
    ],
  },
  {
    id: 'deepseek',
  ...
  },
  {
    ...
    models: [
      { id: 'qwen3.5-plus', label: 'Qwen 3.5 Plus', description: 'Vision-capable balanced model', capabilities: { image: true } },
